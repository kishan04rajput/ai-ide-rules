...
2. **Target location**: Should this be a global skill (available in all projects) or a project-specific skill?
...
If you need clarification, ask the user specific questions to define the skill's parameters:

```
Example questions:
- "Where should this skill be stored? (Global or Project-specific?)"
- "Should this skill include executable scripts?"
```

If your environment supports interactive tools (like an AskQuestion tool), use them; otherwise, ask conversationally.
...
| Type | Path | Scope |
|------|------|-------|
| Global/Personal | [Global Skills Directory] | Available across all your projects |
| Project | [Project Skills Directory] | Shared with anyone using the repository |
...
If the environment supports interactive input tools, use them for efficient structured gathering. Otherwise, ask conversationally.
